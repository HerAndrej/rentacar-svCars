...
export default function AdminLoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    const loginEmail = identifier.includes('@')
      ? identifier
      : `${identifier.toLowerCase().replace(/\s+/g, '')}@staff.internal`;
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-text-secondary mb-1">Email ili korisničko ime</label>
            <input
              type="text"
              value={identifier}
              ...
              placeholder="email ili korisnicko_ime"
            />
          </div>
