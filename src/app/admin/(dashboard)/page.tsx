...
export default async function AdminDashboardPage() {
  ...
  if (role === 'radnik') {
    const [
      { count: myTotalReservations },
      { count: myMonthReservations },
      { count: myPendingReservations },
    ...
    const workerStats = [
      { label: 'Moje rezervacije (30 dana)', value: String(myMonthReservations || 0), icon: CalendarCheck, href: '/admin/reservations', color: 'text-accent' },
      { label: 'Ukupno mojih rezervacija', value: String(myTotalReservations || 0), icon: TrendingUp, href: '/admin/reservations', color: 'text-blue-400' },
      { label: 'Na čekanju', value: String(myPendingReservations || 0), icon: Clock, href: '/admin/reservations', color: 'text-yellow-400' },
      ...
      <div>
        ...
        <div className="bg-bg-card border border-border rounded-xl">
          <div className="p-6 border-b border-border flex items-center justify-between">
            <h2 className="text-lg font-bold font-[family-name:var(--font-montserrat)]">Moje zadnje rezervacije</h2>
